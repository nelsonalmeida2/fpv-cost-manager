...
{
    public WidgetMenuControl NEWSTORE => new WidgetMenuControl(driver, By.Id("w-Menu_A"), ".q-widget");
    public WidgetMenuControl NEWBRAND => new WidgetMenuControl(driver, By.Id("w-Menu_"), ".q-widget");
