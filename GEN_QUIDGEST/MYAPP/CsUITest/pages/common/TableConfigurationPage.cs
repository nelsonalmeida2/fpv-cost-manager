...
public class TableConfigurationPage : PageObject
{
    ...
    /// </summary>
    private IWebElement tableConfigurationContainer => GetElement(driver, By.Id("q-modal-config"));
    ...
    /// </summary>
    public ListControl columnConfigList => new ListControl(driver, By.Id("q-modal-config"), "#column-config");
