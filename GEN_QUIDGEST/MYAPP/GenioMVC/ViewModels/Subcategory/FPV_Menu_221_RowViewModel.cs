...
public class FPV_Menu_221_RowViewModel : Models.Subcategory
{
	#region Constructors
	...
	public FPV_Menu_221_RowViewModel(UserContext userContext, CSGenioAsubcategory val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
