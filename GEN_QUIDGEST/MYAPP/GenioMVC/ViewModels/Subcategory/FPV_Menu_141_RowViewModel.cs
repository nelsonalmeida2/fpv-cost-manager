...
public class FPV_Menu_141_RowViewModel : Models.Subcategory
{
	#region Constructors

	public FPV_Menu_141_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public FPV_Menu_141_RowViewModel(UserContext userContext, CSGenioAsubcategory val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
