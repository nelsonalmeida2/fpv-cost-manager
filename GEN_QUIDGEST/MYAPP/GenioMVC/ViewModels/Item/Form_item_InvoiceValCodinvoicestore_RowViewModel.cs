...
public class Form_item_InvoiceValCodinvoicestore_RowViewModel : Models.Invoice
{
	#region Constructors

	public Form_item_InvoiceValCodinvoicestore_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Form_item_InvoiceValCodinvoicestore_RowViewModel(UserContext userContext, CSGenioAinvoice val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
