...
public class Form_item_SubcategoryValName_RowViewModel : Models.Subcategory
{
	#region Constructors

	public Form_item_SubcategoryValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Form_item_SubcategoryValName_RowViewModel(UserContext userContext, CSGenioAsubcategory val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
