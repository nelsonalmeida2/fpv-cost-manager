...
public class Form_item_BrandValName_RowViewModel : Models.Brand
{
	#region Constructors

	public Form_item_BrandValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Form_item_BrandValName_RowViewModel(UserContext userContext, CSGenioAbrand val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
