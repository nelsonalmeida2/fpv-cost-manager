...
public class FPV_Menu_611_RowViewModel : Models.Item
{
	#region Constructors
	...
	public FPV_Menu_611_RowViewModel(UserContext userContext, CSGenioAitem val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
