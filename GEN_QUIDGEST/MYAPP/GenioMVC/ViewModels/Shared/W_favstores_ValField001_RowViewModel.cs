...
public class W_favstores_ValField001_RowViewModel : Models.Store
{
	#region Constructors
	...
	public W_favstores_ValField001_RowViewModel(UserContext userContext, CSGenioAstore val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
