...
public class W_favbrands_ValField001_RowViewModel : Models.Item
{
	...
	public W_favbrands_ValField001_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
