...
public class FPV_Menu_61_RowViewModel : Models.Photoalbum
{
	#region Constructors
	...
	public FPV_Menu_61_RowViewModel(UserContext userContext, CSGenioAphotoalbum val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
