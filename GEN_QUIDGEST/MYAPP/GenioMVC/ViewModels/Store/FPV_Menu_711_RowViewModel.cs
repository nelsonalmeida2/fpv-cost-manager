...
public class FPV_Menu_711_RowViewModel : Models.Store
{
	#region Constructors
	...
	public FPV_Menu_711_RowViewModel(UserContext userContext, CSGenioAstore val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
