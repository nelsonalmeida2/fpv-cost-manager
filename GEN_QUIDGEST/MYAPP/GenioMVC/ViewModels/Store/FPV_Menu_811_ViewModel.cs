...
{
	public class FPV_Menu_811_ViewModel : MenuListViewModel<Models.Store>
	{
		/// <summary>
...
// USE /[MANUAL FPV LIST_LIMITS 811]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Store.AddEPH<CSGenioAstore>(ref u, crs, "ML811");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Store.AddEPH<CSGenioAstore>(ref u, null, "ML811"));
			}
...
// USE /[MANUAL FPV OVERRQ 811]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAstore>(m_userContext, false, ref fpv_menu_811Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML811", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL FPV OVERRQLIST 811]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAstore.GetInformation(), QMVC_POS_RECORD, sorts, fpv_menu_811Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAstore> listing = Models.ModelBase.Where<CSGenioAstore>(m_userContext, distinct, fpv_menu_811Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML811", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<FPV_Menu_811_RowViewModel> MapFPV_Menu_811(ListingMVC<CSGenioAstore> Qlisting)
		{
		...
		private FPV_Menu_811_RowViewModel MapFPV_Menu_811(CSGenioAstore row)
		{
