...
{
	public class FPV_Menu_3411_ViewModel : MenuListViewModel<Models.Brand>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<FPV_Menu_3411_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "13d1a244-360b-4dec-9b9f-e9329f04baaa";
		...
		{
// USE /[MANUAL FPV LIST_LIMITS 3411]/
		...
		public FPV_Menu_3411_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="FPV_Menu_3411_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public FPV_Menu_3411_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public FPV_Menu_3411_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<FPV_Menu_3411_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Brand.AddEPH<CSGenioAbrand>(ref u, crs, "ML3411");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Brand.AddEPH<CSGenioAbrand>(ref u, null, "ML3411"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAbrand> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet fpv_menu_3411Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(fpv_menu_3411Conds);
			fpv_menu_3411Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL FPV OVERRQ 3411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAbrand>(m_userContext, false, ref fpv_menu_3411Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3411", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL FPV OVERRQLSTEXP 3411]/
			...
			if (tableReload)
			{
// USE /[MANUAL FPV OVERRQLIST 3411]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAbrand.GetInformation(), QMVC_POS_RECORD, sorts, fpv_menu_3411Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAbrand> listing = Models.ModelBase.Where<CSGenioAbrand>(m_userContext, distinct, fpv_menu_3411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapFPV_Menu_3411(listing);
		...
		private List<FPV_Menu_3411_RowViewModel> MapFPV_Menu_3411(ListingMVC<CSGenioAbrand> Qlisting)
		{
			List<FPV_Menu_3411_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapFPV_Menu_3411(row));
					i++;
				}
			}
		...
		/// to a FPV_Menu_3411_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private FPV_Menu_3411_RowViewModel MapFPV_Menu_3411(CSGenioAbrand row)
		{
			var model = new FPV_Menu_3411_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL FPV VIEWMODEL_CUSTOM FPV_MENU_3411]/
