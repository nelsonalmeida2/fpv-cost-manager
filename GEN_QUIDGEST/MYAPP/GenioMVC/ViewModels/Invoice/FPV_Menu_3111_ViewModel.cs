...
{
	public class FPV_Menu_3111_ViewModel : MenuListViewModel<Models.Invoice>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<FPV_Menu_3111_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "48396ffd-20ff-4630-a8e3-6dd88886356a";
		...
		{
// USE /[MANUAL FPV LIST_LIMITS 3111]/
		...
		public FPV_Menu_3111_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="FPV_Menu_3111_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public FPV_Menu_3111_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public FPV_Menu_3111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<FPV_Menu_3111_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Invoice.AddEPH<CSGenioAinvoice>(ref u, crs, "ML3111");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Invoice.AddEPH<CSGenioAinvoice>(ref u, null, "ML3111"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAinvoice> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet fpv_menu_3111Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(fpv_menu_3111Conds);
			fpv_menu_3111Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL FPV OVERRQ 3111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAinvoice>(m_userContext, false, ref fpv_menu_3111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3111", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL FPV OVERRQLSTEXP 3111]/
			...
			if (tableReload)
			{
// USE /[MANUAL FPV OVERRQLIST 3111]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAinvoice.GetInformation(), QMVC_POS_RECORD, sorts, fpv_menu_3111Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAinvoice> listing = Models.ModelBase.Where<CSGenioAinvoice>(m_userContext, distinct, fpv_menu_3111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapFPV_Menu_3111(listing);
		...
		private List<FPV_Menu_3111_RowViewModel> MapFPV_Menu_3111(ListingMVC<CSGenioAinvoice> Qlisting)
		{
			List<FPV_Menu_3111_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapFPV_Menu_3111(row));
					i++;
				}
			}
		...
		/// to a FPV_Menu_3111_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private FPV_Menu_3111_RowViewModel MapFPV_Menu_3111(CSGenioAinvoice row)
		{
			var model = new FPV_Menu_3111_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL FPV VIEWMODEL_CUSTOM FPV_MENU_3111]/
