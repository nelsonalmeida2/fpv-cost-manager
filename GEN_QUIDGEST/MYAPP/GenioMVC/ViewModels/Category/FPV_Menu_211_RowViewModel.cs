...
public class FPV_Menu_211_RowViewModel : Models.Category
{
	#region Constructors
	...
	public FPV_Menu_211_RowViewModel(UserContext userContext, CSGenioAcategory val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
