...
{
	public class FPV_Menu_211_ViewModel : MenuListViewModel<Models.Category>
	{
		/// <summary>
...
// USE /[MANUAL FPV LIST_LIMITS 211]/
		...
		public void LoadToExportTemplate(out List<Exports.QColumn> columns)
		{
			columns = new List<Exports.QColumn>()
			{
				...
				new Exports.QColumn(CSGenioAcategory.FldDescription, FieldType.TEXT, Resources.Resources.DESCRIPTION07383, 255, 0, true),
				...
				new Exports.QColumn(CSGenioAcategory.FldUpdated_by, FieldType.TEXT, Resources.Resources.UPDATED_BY17808, 100, 0, true),
				new Exports.QColumn(CSGenioAcategory.FldCreated_by, FieldType.TEXT, Resources.Resources.CREATED_BY12292, 100, 0, true),
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Category.AddEPH<CSGenioAcategory>(ref u, crs, "ML211");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Category.AddEPH<CSGenioAcategory>(ref u, null, "ML211"));
			}
...
// USE /[MANUAL FPV OVERRQ 211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcategory>(m_userContext, false, ref fpv_menu_211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL FPV OVERRQLIST 211]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcategory.GetInformation(), QMVC_POS_RECORD, sorts, fpv_menu_211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAcategory> listing = Models.ModelBase.Where<CSGenioAcategory>(m_userContext, distinct, fpv_menu_211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<FPV_Menu_211_RowViewModel> MapFPV_Menu_211(ListingMVC<CSGenioAcategory> Qlisting)
		{
		...
		private FPV_Menu_211_RowViewModel MapFPV_Menu_211(CSGenioAcategory row)
		{
