...
{
	public class FPV_Menu_131_ViewModel : MenuListViewModel<Models.Category>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<FPV_Menu_131_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "2432b685-6190-495f-babd-3fea02845f18";
		...
		{
// USE /[MANUAL FPV LIST_LIMITS 131]/
		...
		public override int GetCount(User user)
		{
			...
			var areaBase = CSGenio.business.Area.createArea("category", user, "FPV");
		...
		public FPV_Menu_131_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="FPV_Menu_131_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public FPV_Menu_131_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public FPV_Menu_131_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<FPV_Menu_131_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Category.AddEPH<CSGenioAcategory>(ref u, crs, "ML131");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Category.AddEPH<CSGenioAcategory>(ref u, null, "ML131"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcategory> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet fpv_menu_131Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(fpv_menu_131Conds);
			fpv_menu_131Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL FPV OVERRQ 131]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcategory>(m_userContext, false, ref fpv_menu_131Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML131", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL FPV OVERRQLSTEXP 131]/
...
// USE /[MANUAL FPV OVERRQLIST 131]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcategory.GetInformation(), QMVC_POS_RECORD, sorts, fpv_menu_131Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAcategory> listing = Models.ModelBase.Where<CSGenioAcategory>(m_userContext, distinct, fpv_menu_131Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML131", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapFPV_Menu_131(listing);
		...
		private List<FPV_Menu_131_RowViewModel> MapFPV_Menu_131(ListingMVC<CSGenioAcategory> Qlisting)
		{
			List<FPV_Menu_131_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapFPV_Menu_131(row));
					i++;
				}
			}
		...
		/// to a FPV_Menu_131_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private FPV_Menu_131_RowViewModel MapFPV_Menu_131(CSGenioAcategory row)
		{
			var model = new FPV_Menu_131_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL FPV VIEWMODEL_CUSTOM FPV_MENU_131]/
