...
public class FPV_Menu_321_RowViewModel : Models.Person
{
	#region Constructors
	...
	public FPV_Menu_321_RowViewModel(UserContext userContext, CSGenioAperson val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
