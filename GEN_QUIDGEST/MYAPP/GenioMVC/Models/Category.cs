...
namespace GenioMVC.Models
{
	public class Category : ModelBase
	{
		...
		[ShouldSerialize("Category.ValUpdated_at")]
		...
		[ShouldSerialize("Category.ValCreated_at")]
		[DataType(DataType.Date)]
		[DateAttribute("OD")]
