...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_FPV_MENU_221 = new NavigationLocation("ITEMS55321", "FPV_Menu_221", "Item") { vueRouteName = "menu-FPV_221" };


		//
		// GET: /Item/FPV_Menu_221
