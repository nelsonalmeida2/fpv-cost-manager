...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_FPV_MENU_41 = new NavigationLocation("STORES21606", "FPV_Menu_41", "Store") { vueRouteName = "menu-FPV_41" };


		//
		// GET: /Store/FPV_Menu_41
