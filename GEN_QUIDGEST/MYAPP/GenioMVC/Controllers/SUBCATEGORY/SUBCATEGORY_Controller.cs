...
namespace GenioMVC.Controllers
{
	public partial class SubcategoryController : ControllerBase
	{
		...
		public SubcategoryController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL FPV CONTROLLER_NAVIGATION SUBCATEGORY]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAsubcategory>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
...
// USE /[MANUAL FPV MANUAL_CONTROLLER SUBCATEGORY]/
		...
		{
			return base.GetDocumsTickets("SUBCATEGORY", requestModel.FieldName, requestModel.KeyValue);
		}
