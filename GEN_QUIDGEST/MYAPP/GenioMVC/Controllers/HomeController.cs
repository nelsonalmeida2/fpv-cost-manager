...
namespace GenioMVC.Controllers
{
	...
	public class HomeController(UserContextService userContext) : ControllerBase(userContext)
	{
		...
		private static readonly NavigationLocation ACTION_TOTALSPENDING_SHOW = new("CONSULTA40695", "Totalspending_Show", "Home")  { vueRouteName = "form-TOTALSPENDING", mode = "SHOW" };
		private static readonly NavigationLocation ACTION_TOTALSPENDING_EDIT = new("EDITAR11616", "Totalspending_Edit", "Home")  { vueRouteName = "form-TOTALSPENDING", mode = "EDIT" };
...
// USE /[MANUAL FPV HOME_CONTROLLER_INDEX]/
		[HttpGet]
		[AllowAnonymous]
		...
		#region Form Methods -> Totalspending ()

		// GET: /Home/Totalspending_Show
		public ActionResult Totalspending_Show()
		{
			Totalspending_ViewModel model = new(UserContext.Current);
			CSGenio.framework.StatusMessage permission = model.CheckPermissions(FormMode.Show);
			bool isHomePage = RouteData.Values.ContainsKey("isHomePage") && (bool)RouteData.Values["isHomePage"];
			ViewBag.isHomePage = isHomePage;
			if (isHomePage)
				Navigation.SetValue("HomePage", "Totalspending");
			if (permission.Status.Equals(CSGenio.framework.Status.E))
				return PermissionError(permission.Message);

			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_TOTALSPENDING_SHOW.ShortDescription());

// USE /[MANUAL FPV BEFORE_LOAD_SHOW TOTALSPENDING]/

			model.Load([], true);

// USE /[MANUAL FPV AFTER_LOAD_SHOW TOTALSPENDING]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult Totalspending_Show_GET()
		{
			return Totalspending_Show();
		}

		// GET: /Home/Totalspending_Edit
		public ActionResult Totalspending_Edit()
		{
			Totalspending_ViewModel model = new(UserContext.Current);
			...
			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_TOTALSPENDING_EDIT.ShortDescription());

// USE /[MANUAL FPV BEFORE_LOAD_EDIT TOTALSPENDING]/

			model.Load([], true);

// USE /[MANUAL FPV AFTER_LOAD_EDIT TOTALSPENDING]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult Totalspending_Edit_GET()
		{
			return Totalspending_Edit();
		}

		//
		// GET: /Home/Totalspending_Cancel
// USE /[MANUAL FPV CONTROLLER_CANCEL_GET TOTALSPENDING]/
		public ActionResult Totalspending_Cancel()
		{
			return JsonOK(new { Success = true });
		}

		//
		// GET: /Home/Totalspending_ValField001
		// POST: /Home/Totalspending_ValField001
		[ActionName("Totalspending_ValField001")]
		public ActionResult Totalspending_ValField001([FromBody] RequestLookupModel requestModel)
		{
			...
			Totalspending_ValField001_ViewModel model = new(m_userContext);
...
// USE /[MANUAL FPV CONTROLLER_CANCEL_GET W_EXPENSESOVERTIME]/
		...
		// GET: /Home/W_favbrands_Show
		public ActionResult W_favbrands_Show()
		{
			W_favbrands_ViewModel model = new(UserContext.Current);
			CSGenio.framework.StatusMessage permission = model.CheckPermissions(FormMode.Show);
			bool isHomePage = RouteData.Values.ContainsKey("isHomePage") && (bool)RouteData.Values["isHomePage"];
			ViewBag.isHomePage = isHomePage;
			if (isHomePage)
				Navigation.SetValue("HomePage", "W_favbrands");
			if (permission.Status.Equals(CSGenio.framework.Status.E))
				return PermissionError(permission.Message);

			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_W_FAVBRANDS_SHOW.ShortDescription());

// USE /[MANUAL FPV BEFORE_LOAD_SHOW W_FAVBRANDS]/

			model.Load([], true);

// USE /[MANUAL FPV AFTER_LOAD_SHOW W_FAVBRANDS]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult W_favbrands_Show_GET()
		{
			return W_favbrands_Show();
		}

		// GET: /Home/W_favbrands_Edit
		public ActionResult W_favbrands_Edit()
		{
			W_favbrands_ViewModel model = new(UserContext.Current);
			CSGenio.framework.StatusMessage permission = model.CheckPermissions(FormMode.Edit);
			bool isHomePage = RouteData.Values.ContainsKey("isHomePage") && (bool)RouteData.Values["isHomePage"];
			...
			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_W_FAVBRANDS_EDIT.ShortDescription());

// USE /[MANUAL FPV BEFORE_LOAD_EDIT W_FAVBRANDS]/

			model.Load([], true);

// USE /[MANUAL FPV AFTER_LOAD_EDIT W_FAVBRANDS]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult W_favbrands_Edit_GET()
		{
			return W_favbrands_Edit();
		}

		//
		// GET: /Home/W_favbrands_Cancel
// USE /[MANUAL FPV CONTROLLER_CANCEL_GET W_FAVBRANDS]/
		public ActionResult W_favbrands_Cancel()
		{
			return JsonOK(new { Success = true });
		}

		//
		// GET: /Home/W_favbrands_ValField001
		// POST: /Home/W_favbrands_ValField001
		[ActionName("W_favbrands_ValField001")]
		public ActionResult W_favbrands_ValField001([FromBody] RequestLookupModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
...
// USE /[MANUAL FPV CONTROLLER_CANCEL_GET W_FAVSTORES]/
		...
		#region Form Methods -> W_lastinvoice (Last Invoice)

		// GET: /Home/W_lastinvoice_Show
		public ActionResult W_lastinvoice_Show()
		{
			W_lastinvoice_ViewModel model = new(UserContext.Current);
			CSGenio.framework.StatusMessage permission = model.CheckPermissions(FormMode.Show);
			bool isHomePage = RouteData.Values.ContainsKey("isHomePage") && (bool)RouteData.Values["isHomePage"];
			ViewBag.isHomePage = isHomePage;
			if (isHomePage)
				Navigation.SetValue("HomePage", "W_lastinvoice");
			if (permission.Status.Equals(CSGenio.framework.Status.E))
				return PermissionError(permission.Message);

			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_W_LASTINVOICE_SHOW.ShortDescription());

// USE /[MANUAL FPV BEFORE_LOAD_SHOW W_LASTINVOICE]/

			model.Load([], true);

// USE /[MANUAL FPV AFTER_LOAD_SHOW W_LASTINVOICE]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult W_lastinvoice_Show_GET()
		{
			return W_lastinvoice_Show();
		}

		// GET: /Home/W_lastinvoice_Edit
		public ActionResult W_lastinvoice_Edit()
		{
			W_lastinvoice_ViewModel model = new(UserContext.Current);
			CSGenio.framework.StatusMessage permission = model.CheckPermissions(FormMode.Edit);
			bool isHomePage = RouteData.Values.ContainsKey("isHomePage") && (bool)RouteData.Values["isHomePage"];
			...
			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_W_LASTINVOICE_EDIT.ShortDescription());

// USE /[MANUAL FPV BEFORE_LOAD_EDIT W_LASTINVOICE]/

			model.Load([], true);

// USE /[MANUAL FPV AFTER_LOAD_EDIT W_LASTINVOICE]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult W_lastinvoice_Edit_GET()
		{
			return W_lastinvoice_Edit();
		}

		//
		// GET: /Home/W_lastinvoice_Cancel
// USE /[MANUAL FPV CONTROLLER_CANCEL_GET W_LASTINVOICE]/
		public ActionResult W_lastinvoice_Cancel()
		{
			return JsonOK(new { Success = true });
		}

		//
		// GET: /Home/W_lastinvoice_ValField001
		// POST: /Home/W_lastinvoice_ValField001
		[ActionName("W_lastinvoice_ValField001")]
		public ActionResult W_lastinvoice_ValField001([FromBody] RequestLookupModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			W_lastinvoice_ValField001_ViewModel model = new(m_userContext);
...
// USE /[MANUAL FPV HOME_CONTROLLER_MANUAL]/
