...
namespace GenioMVC.Controllers
{
	public partial class PersonController : ControllerBase
	{
		...
		public PersonController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL FPV CONTROLLER_NAVIGATION PERSON]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAperson>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL FPV MANUAL_CONTROLLER PERSON]/
		...
		/// <summary>
		/// Recalculate formulas of the "Form_person" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Form_person([FromBody]Form_person_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "person",
				(primaryKey) => Models.Person.Find(primaryKey, UserContext.Current, "FFORM_PERSON"),
				(model) => formData.MapToModel(model as Models.Person)
			);
		}
		...
		{
			return base.GetDocumsTickets("PERSON", requestModel.FieldName, requestModel.KeyValue);
		}
