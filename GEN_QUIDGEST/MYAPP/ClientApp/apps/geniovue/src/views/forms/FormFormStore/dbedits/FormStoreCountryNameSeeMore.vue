<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-form-store-country-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FORM_STORE__COUNTRY__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FormStoreCountryNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FORM_STORE__COUNTRY__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'FORM_STORE__COUNTRY__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FORM_STORE__COUNTRY__NAME_SeeMore',
					name: 'FORM_STORE__COUNTRY__NAME_SeeMore',
					controller: 'STORE',
					action: 'FORM_STORE_CountryValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-form-store-country-name',
				dismissAction: this.close,
				returnElement: 'FORM_STORE__COUNTRY__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-form-store-country-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Form_store_CountryValName',
							serverMode: true,
						...
						uuid: 'Form_store_Form_store_CountryValName',
