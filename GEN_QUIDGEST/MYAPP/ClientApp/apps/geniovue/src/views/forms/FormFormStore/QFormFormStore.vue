				...
				<q-row v-if="controls.FORM_STORE__PSEUD__NEWGRP02.isVisible">
					<q-col v-if="controls.FORM_STORE__PSEUD__NEWGRP02.isVisible">
						<q-group-box-container
							v-if="controls.FORM_STORE__PSEUD__NEWGRP02.isVisible"
							id="FORM_STORE__PSEUD__NEWGRP02"
							v-bind="controls.FORM_STORE__PSEUD__NEWGRP02"
							:is-visible="controls.FORM_STORE__PSEUD__NEWGRP02.isVisible">
							<!-- Start FORM_STORE__PSEUD__NEWGRP02 -->
							<q-row v-if="controls.FORM_STORE__STORE__LOGOTYPE.isVisible">
								<q-col v-if="controls.FORM_STORE__STORE__LOGOTYPE.isVisible">
									<base-input-structure
										v-if="controls.FORM_STORE__STORE__LOGOTYPE.isVisible"
										class="q-image"
										v-bind="controls.FORM_STORE__STORE__LOGOTYPE"
										v-on="controls.FORM_STORE__STORE__LOGOTYPE.handlers"
										:loading="controls.FORM_STORE__STORE__LOGOTYPE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-image
											v-if="controls.FORM_STORE__STORE__LOGOTYPE.isVisible"
											v-bind="controls.FORM_STORE__STORE__LOGOTYPE.props"
											v-on="controls.FORM_STORE__STORE__LOGOTYPE.handlers" />
									</base-input-structure>
								</q-col>
							</q-row>
							<q-row v-if="controls.FORM_STORE__STORE__NAME.isVisible">
								<q-col
									v-if="controls.FORM_STORE__STORE__NAME.isVisible"
									cols="auto">
									<base-input-structure
										v-if="controls.FORM_STORE__STORE__NAME.isVisible"
										class="i-text"
										v-bind="controls.FORM_STORE__STORE__NAME"
										v-on="controls.FORM_STORE__STORE__NAME.handlers"
										:loading="controls.FORM_STORE__STORE__NAME.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.FORM_STORE__STORE__NAME.props"
											@blur="onBlur(controls.FORM_STORE__STORE__NAME, model.ValName.value)"
											@change="model.ValName.fnUpdateValueOnChange" />
									</base-input-structure>
								</q-col>
							</q-row>
							<q-row v-if="controls.FORM_STORE__STORE__DESCRIPTION.isVisible">
								<q-col
									v-if="controls.FORM_STORE__STORE__DESCRIPTION.isVisible"
									cols="auto">
									<base-input-structure
										v-if="controls.FORM_STORE__STORE__DESCRIPTION.isVisible"
										class="i-text"
										v-bind="controls.FORM_STORE__STORE__DESCRIPTION"
										v-on="controls.FORM_STORE__STORE__DESCRIPTION.handlers"
										:loading="controls.FORM_STORE__STORE__DESCRIPTION.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.FORM_STORE__STORE__DESCRIPTION.props"
											@blur="onBlur(controls.FORM_STORE__STORE__DESCRIPTION, model.ValDescription.value)"
											@change="model.ValDescription.fnUpdateValueOnChange" />
									</base-input-structure>
								</q-col>
							</q-row>
							<q-row v-if="controls.FORM_STORE__STORE__SITE.isVisible">
								<q-col
									v-if="controls.FORM_STORE__STORE__SITE.isVisible"
									cols="auto">
									<base-input-structure
										v-if="controls.FORM_STORE__STORE__SITE.isVisible"
										class="i-text"
										v-bind="controls.FORM_STORE__STORE__SITE"
										v-on="controls.FORM_STORE__STORE__SITE.handlers"
										:loading="controls.FORM_STORE__STORE__SITE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.FORM_STORE__STORE__SITE.props"
											@blur="onBlur(controls.FORM_STORE__STORE__SITE, model.ValSite.value)"
											@change="model.ValSite.fnUpdateValueOnChange" />
									</base-input-structure>
								</q-col>
							</q-row>
							<q-row v-if="controls.FORM_STORE__STORE__CURRENCY.isVisible">
								<q-col
									v-if="controls.FORM_STORE__STORE__CURRENCY.isVisible"
									cols="auto">
									<base-input-structure
										v-if="controls.FORM_STORE__STORE__CURRENCY.isVisible"
										class="i-text"
										v-bind="controls.FORM_STORE__STORE__CURRENCY"
										v-on="controls.FORM_STORE__STORE__CURRENCY.handlers"
										:loading="controls.FORM_STORE__STORE__CURRENCY.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-select
											v-if="controls.FORM_STORE__STORE__CURRENCY.isVisible"
											v-bind="controls.FORM_STORE__STORE__CURRENCY.props"
											@update:model-value="model.ValCurrency.fnUpdateValue" />
									</base-input-structure>
								</q-col>
							</q-row>
							<q-row v-if="controls.FORM_STORE__COUNTRY__NAME.isVisible">
								<q-col
									v-if="controls.FORM_STORE__COUNTRY__NAME.isVisible"
									cols="auto">
									<base-input-structure
										v-if="controls.FORM_STORE__COUNTRY__NAME.isVisible"
										class="i-text"
										v-bind="controls.FORM_STORE__COUNTRY__NAME"
										v-on="controls.FORM_STORE__COUNTRY__NAME.handlers"
										:loading="controls.FORM_STORE__COUNTRY__NAME.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-lookup
											v-if="controls.FORM_STORE__COUNTRY__NAME.isVisible"
											v-bind="controls.FORM_STORE__COUNTRY__NAME.props"
											v-on="controls.FORM_STORE__COUNTRY__NAME.handlers" />
										<q-see-more-form-store-country-name
											v-if="controls.FORM_STORE__COUNTRY__NAME.seeMoreIsVisible"
											v-bind="controls.FORM_STORE__COUNTRY__NAME.seeMoreParams"
											v-on="controls.FORM_STORE__COUNTRY__NAME.handlers" />
									</base-input-structure>
								</q-col>
							</q-row>
...
<script>
	...
	import FormViewModel from './QFormFormStoreViewModel.js'

	const requiredTextResources = ['QFormFormStore', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV FORM_INCLUDEJS FORM_STORE]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreFormStoreCountryName: defineAsyncComponent(() => import('@/views/forms/FormFormStore/dbedits/FormStoreCountryNameSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormFormStore', false),

				interfaceMetadata: {
					id: 'QFormFormStore', // Used for resources
				...
				formInfo: {
					type: 'normal',
					name: 'FORM_STORE',
					route: 'form-FORM_STORE',
					area: 'STORE',
					primaryKey: 'ValCodstore',
					designation: computed(() => this.Resources.STORE16493),
				...
				controls: {
					...
					FORM_STORE__PSEUD__NEWGRP02: new fieldControlClass.GroupControl({
						...
						name: 'NEWGRP02',
						size: 'block',
						label: computed(() => this.Resources.STORE_INFO07800),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						isCollapsible: false,
						anchored: false,
						directChildren: ['FORM_STORE__STORE__LOGOTYPE', 'FORM_STORE__STORE__NAME', 'FORM_STORE__STORE__DESCRIPTION', 'FORM_STORE__STORE__SITE', 'FORM_STORE__STORE__CURRENCY', 'FORM_STORE__COUNTRY__NAME'],
						mustBeFilled: true,
						controlLimits: [
						],
					}, this),
					FORM_STORE__STORE__LOGOTYPE: new fieldControlClass.ImageControl({
						modelField: 'ValLogotype',
						valueChangeEvent: 'fieldChange:store.logotype',
						id: 'FORM_STORE__STORE__LOGOTYPE',
						name: 'LOGOTYPE',
						size: 'block',
						label: computed(() => this.Resources.LOGOTYPE44505),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'FORM_STORE__PSEUD__NEWGRP02',
						height: 50,
						width: 30,
					...
					FORM_STORE__STORE__NAME: new fieldControlClass.StringControl({
						modelField: 'ValName',
						valueChangeEvent: 'fieldChange:store.name',
						id: 'FORM_STORE__STORE__NAME',
						name: 'NAME',
						size: 'xxlarge',
					...
					FORM_STORE__STORE__DESCRIPTION: new fieldControlClass.StringControl({
						modelField: 'ValDescription',
						valueChangeEvent: 'fieldChange:store.description',
						id: 'FORM_STORE__STORE__DESCRIPTION',
						name: 'DESCRIPTION',
						size: 'xxlarge',
					...
					FORM_STORE__STORE__SITE: new fieldControlClass.StringControl({
						modelField: 'ValSite',
						valueChangeEvent: 'fieldChange:store.site',
						id: 'FORM_STORE__STORE__SITE',
						name: 'SITE',
						size: 'xxlarge',
					...
					FORM_STORE__STORE__CURRENCY: new fieldControlClass.ArrayStringControl({
						modelField: 'ValCurrency',
						valueChangeEvent: 'fieldChange:store.currency',
						id: 'FORM_STORE__STORE__CURRENCY',
						name: 'CURRENCY',
						size: 'small',
					...
					FORM_STORE__COUNTRY__NAME: new fieldControlClass.LookupControl({
						modelField: 'TableCountryName',
						valueChangeEvent: 'fieldChange:country.name',
						id: 'FORM_STORE__COUNTRY__NAME',
						name: 'NAME',
						size: 'xxlarge',
						...
						lookupKeyModelField: {
							name: 'ValCountry',
							dependencyEvent: 'fieldChange:store.country'
						},
						dependentFields: () => ({
				...
				dataApi: {
					...
					Store: {
						...
						get ValSite() { return vm.model.ValSite.value },
						set ValSite(value) { vm.model.ValSite.updateValue(value) },
					...
					keys: {
						/** The primary key of the STORE table */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV FORM_CODEJS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV COMPONENT_BEFORE_UNMOUNT FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV BEFORE_LOAD_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV FORM_LOADED_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV BEFORE_APPLY_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV AFTER_APPLY_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV BEFORE_SAVE_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV AFTER_SAVE_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV BEFORE_DEL_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV AFTER_DEL_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV BEFORE_EXIT_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV AFTER_EXIT_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV DLGUPDT FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV CTRLBLR FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV CTRLUPD FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV FUNCTIONS_JS FORM_STORE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
