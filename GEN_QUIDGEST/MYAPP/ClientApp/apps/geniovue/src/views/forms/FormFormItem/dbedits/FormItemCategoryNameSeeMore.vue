<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-form-item-category-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FORM_ITEM__CATEGORY__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FormItemCategoryNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FORM_ITEM__CATEGORY__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'FORM_ITEM__CATEGORY__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FORM_ITEM__CATEGORY__NAME_SeeMore',
					name: 'FORM_ITEM__CATEGORY__NAME_SeeMore',
					controller: 'ITEM',
					action: 'FORM_ITEM_CategoryValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-form-item-category-name',
				dismissAction: this.close,
				returnElement: 'FORM_ITEM__CATEGORY__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-form-item-category-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Form_item_CategoryValName',
							serverMode: true,
						...
						uuid: 'Form_item_Form_item_CategoryValName',
