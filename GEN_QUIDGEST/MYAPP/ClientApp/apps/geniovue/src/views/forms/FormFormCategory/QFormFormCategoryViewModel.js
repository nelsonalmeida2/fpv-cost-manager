...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'CATEGORY',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Form_category',
				updateFilesTickets: 'UpdateFilesTicketsForm_category',
				setFile: 'SetFileForm_category'
			}
		})
		...
		this.stopWatchers.push(watch(() => this.ValCreated_by.value, (newValue, oldValue) => this.onUpdate('category.created_by', this.ValCreated_by, newValue, oldValue)))
		...
		this.stopWatchers.push(watch(() => this.ValCreated_at.value, (newValue, oldValue) => this.onUpdate('category.created_at', this.ValCreated_at, newValue, oldValue)))
		...
		this.stopWatchers.push(watch(() => this.ValUpdated_by.value, (newValue, oldValue) => this.onUpdate('category.updated_by', this.ValUpdated_by, newValue, oldValue)))
		...
		this.stopWatchers.push(watch(() => this.ValUpdated_at.value, (newValue, oldValue) => this.onUpdate('category.updated_at', this.ValUpdated_at, newValue, oldValue)))
	...
	/**
	 * Creates a clone of the current QFormFormCategoryViewModel instance.
	 * @returns {QFormFormCategoryViewModel} A new instance of QFormFormCategoryViewModel
	 */
	clone()
	{
