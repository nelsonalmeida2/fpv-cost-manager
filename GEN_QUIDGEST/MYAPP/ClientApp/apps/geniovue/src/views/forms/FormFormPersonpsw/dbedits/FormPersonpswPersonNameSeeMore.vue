<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-form-personpsw-person-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FORM_PERSONPSW__PERSON__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FormPersonpswPersonNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FORM_PERSONPSW__PERSON__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'FORM_PERSONPSW__PERSON__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FORM_PERSONPSW__PERSON__NAME_SeeMore',
					name: 'FORM_PERSONPSW__PERSON__NAME_SeeMore',
					controller: 'PERSONPSW',
					action: 'FORM_PERSONPSW_PersonValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-form-personpsw-person-name',
				dismissAction: this.close,
				returnElement: 'FORM_PERSONPSW__PERSON__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-form-personpsw-person-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Form_personpsw_PersonValName',
							serverMode: true,
						...
						uuid: 'Form_personpsw_Form_personpsw_PersonValName',
