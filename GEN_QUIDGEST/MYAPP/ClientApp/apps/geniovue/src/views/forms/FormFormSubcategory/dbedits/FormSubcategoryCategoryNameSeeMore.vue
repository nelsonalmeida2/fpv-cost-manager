<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-form-subcategory-category-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FORM_SUBCATEGORY__CATEGORY__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FormSubcategoryCategoryNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FORM_SUBCATEGORY__CATEGORY__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'FORM_SUBCATEGORY__CATEGORY__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FORM_SUBCATEGORY__CATEGORY__NAME_SeeMore',
					name: 'FORM_SUBCATEGORY__CATEGORY__NAME_SeeMore',
					controller: 'SUBCATEGORY',
					action: 'FORM_SUBCATEGORY_CategoryValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-form-subcategory-category-name',
				dismissAction: this.close,
				returnElement: 'FORM_SUBCATEGORY__CATEGORY__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-form-subcategory-category-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Form_subcategory_CategoryValName',
							serverMode: true,
						...
						uuid: 'Form_subcategory_Form_subcategory_CategoryValName',
