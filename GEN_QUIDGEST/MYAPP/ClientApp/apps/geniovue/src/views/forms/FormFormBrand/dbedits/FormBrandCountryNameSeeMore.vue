<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-form-brand-country-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FORM_BRAND__COUNTRY__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FormBrandCountryNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FORM_BRAND__COUNTRY__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'FORM_BRAND__COUNTRY__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FORM_BRAND__COUNTRY__NAME_SeeMore',
					name: 'FORM_BRAND__COUNTRY__NAME_SeeMore',
					controller: 'BRAND',
					action: 'FORM_BRAND_CountryValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-form-brand-country-name',
				dismissAction: this.close,
				returnElement: 'FORM_BRAND__COUNTRY__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-form-brand-country-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Form_brand_CountryValName',
							serverMode: true,
						...
						uuid: 'Form_brand_Form_brand_CountryValName',
