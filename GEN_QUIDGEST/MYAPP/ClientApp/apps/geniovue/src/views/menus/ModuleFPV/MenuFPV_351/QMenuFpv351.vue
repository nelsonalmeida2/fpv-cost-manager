		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL FPV CUSTOM_TABLE FPV_Menu_351]/ -->
				</q-table>
			</q-row-container>
		</form>
	</teleport>
...
<script>
	...
	import MenuViewModel from './QMenuFPV_351ViewModel.js'

	const requiredTextResources = ['QMenuFPV_351', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV FORM_INCLUDEJS FPV_MENU_351]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuFPV_351', false),

				interfaceMetadata: {
					id: 'QMenuFPV_351', // Used for resources
				...
				controls: {
					menu: new controlClass.TableSpecialRenderingControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									action: vm.openMenuAction, type: 'menu', menuName: 'FPV_3511'
								}
							},
							formsDefinition: {
								'FORM_PERSON': {
						...
						uuid: '5a65b28e-1107-411e-a5af-98a7ee5f2979',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV FORM_CODEJS FPV_MENU_351]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV COMPONENT_BEFORE_UNMOUNT FPV_MENU_351]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV FUNCTIONS_JS FPV_351]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL FPV LISTING_CODEJS FPV_MENU_351]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
