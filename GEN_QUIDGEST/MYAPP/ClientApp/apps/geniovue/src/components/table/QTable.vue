	...
	<div
		...
		<div
			...
			<q-row
				...
				<!-- BEGIN: Table title -->
				<q-col
					v-if="tableTitle.length > 0 || $slots.tableTitle"
						...
						<q-col
							v-if="
								tableTitle.length > 0 ||
									$slots.tableTitle ||
									showConfigMenu ||
									$props.viewModes.length > 0 ||
									(showRowDragAndDropOption && !readonly) ||
									allowFileExport ||
									allowFileImport
							"
							cols="auto">
		...
		<component
			...
			<div
				...
				<q-table-current-filters
					...
					@show-filters="emitEvent('show-config', { selectedTab: 'filters', selectedFilter: $event })" />
			</div>
			<!-- END: Filters -->
			<div
				v-if="isListVisible"
					...
					<div
						...
						<table
							...
							<q-table-header
								...
								@update:filters="emitEvent('update:filters', $event)"
								@show-filters="emitEvent('show-config', { selectedTab: 'filters', columnName: $event })"
