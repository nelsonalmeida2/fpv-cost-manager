...
export default {
	install: (app) => {
		...
		app.component('QFormTotalspending', defineAsyncComponent(() => import('@/views/forms/FormTotalspending/QFormTotalspending.vue')))
		app.component('QFormWExpensesovertime', defineAsyncComponent(() => import('@/views/forms/FormWExpensesovertime/QFormWExpensesovertime.vue')))
