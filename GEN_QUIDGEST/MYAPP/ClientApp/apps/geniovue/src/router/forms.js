...
export default function getFormsRoutes()
{
	return [
		...
		},
		{
			...
			props: route => propsConverter(route),
			component: () => import('@/views/forms/FormWExpensesovertime/QFormWExpensesovertime.vue'),
			meta: {
				routeType: 'form',
				baseArea: '',
				humanKeyFields: [],
		...
		{
			path: '/:culture/:system/:module/form/W_FAVBRANDS/:mode/:id?',
			name: 'form-W_FAVBRANDS',
			props: route => propsConverter(route),
			component: () => import('@/views/forms/FormWFavbrands/QFormWFavbrands.vue'),
			meta: {
				routeType: 'form',
				baseArea: '',
				humanKeyFields: [],
