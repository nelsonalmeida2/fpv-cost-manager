...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("FPV", "userauthorization", "userauthorization", "codua", "codpsw", "FPV", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL FPV TABAUX UserAuthorization]/
