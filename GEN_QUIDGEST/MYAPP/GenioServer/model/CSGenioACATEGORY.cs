...
namespace CSGenio.business
{
	...
	public class CSGenioAcategory : DbArea
	{
		...
		public CSGenioAcategory(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL FPV CONSTRUTOR CATEGORY]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ChildTable[0]= new ChildRelation("subcategory", new String[] {"category"}, DeleteProc.NA);
			info.ChildTable[1]= new ChildRelation("item", new String[] {"category"}, DeleteProc.NA);
		...
		private static FieldRef m_fldUpdated_at = new FieldRef("category", "updated_at");
		...
		private static FieldRef m_fldUpdated_by = new FieldRef("category", "updated_by");
		...
		private static FieldRef m_fldCreated_by = new FieldRef("category", "created_by");
		...
		private static FieldRef m_fldCreated_at = new FieldRef("category", "created_at");
		...
		// USE /[MANUAL FPV TABAUX CATEGORY]/
