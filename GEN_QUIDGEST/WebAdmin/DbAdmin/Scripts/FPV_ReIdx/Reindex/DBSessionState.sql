...
SET @SQL = N'
CREATE DATABASE [ASPStateFPV]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateFPV'', FILENAME = N''' + @SQLDataFolder + 'ASPStateFPV.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateFPV_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateFPV_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateFPV_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateFPV_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateFPV_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateFPV] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateFPV] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
