...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("person", new Relation("FPV", "fpvinvoice", "invoice", "codinvoice", "codperson", "FPV", "fpvperson", "person", "codperson", "codperson"));
		...
		private static FieldRef m_fldCodperson = new FieldRef("invoice", "codperson");
