    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("FPVMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("FPVMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("FPVMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("FPVMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("FPVMQQueues_History", "ANO", "ANO")
                            .Select("FPVMQQueues_History", "USERNAME", "USERNAME")
                            .Select("FPVMQQueues_History", "TABELA", "TABELA")
                            .Select("FPVMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("FPVMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("FPVMQQueues_History", "QUEUE", "QUEUE")
                            .Select("FPVMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("FPVMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("FPVMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("FPVMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("FPVMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("FPVMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("FPVMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("FPVMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("FPVMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.FPVMQQueues_History";
